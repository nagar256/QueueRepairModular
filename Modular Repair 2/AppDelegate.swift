...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Modular_Repair_2", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent("Modular_Repair_2.storedata")
            do {
    ...
    //Para que cierre la aplicacion cuando cierren el documento.
